# 课程讲义生成器 (Course Handout Generator)

一个用于 **Claude Code** 的技能，根据教材、PPT、往年考卷等资料自动生成系统化的 LaTeX 课程讲义 PDF。
...
1. 克隆仓库：
   ```bash
   git clone git@github.com:biubiumen/course-handout-generator.git
   ```
2. 放到 Claude Code skills 目录：
   ```
   ~/.claude/skills/course-handout-generator/
   ```
...
```
用户：我有一本高数教材和660题，要考研数三，帮我整理课程讲义
